...
all_models, if_others, out_path, out_dir, need_test, minimum_product_columns, minimum_product_sep, minimum_product_newname, if_two_source, bedsize, hospital_level, id_bedsize_path):
    logger = phs3logger()
