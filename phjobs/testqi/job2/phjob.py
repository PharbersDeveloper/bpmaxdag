...
#     spark = kwargs["spark"]()
    ...
    logger.info(("read: "+kwargs["project_path"]+kwargs["parent_path"]+kwargs["run_id_path"]+kwargs["split_data_path"]+kwargs["job_id_path"])
    logger.info(("write: " + kwargs["output_path"])
    return {}
