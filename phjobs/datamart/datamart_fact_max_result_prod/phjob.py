...
def execute(**kwargs):
    ...
    spark = SparkSession.builder \
        .master("yarn") \
        .appName("datamart original dim max_result_prod job") \
    ...
    max_result_prod_data_df = reading.select(
            "Molecule",
			"Prod_Name",
    ...
    max_result_prod_data_df.write.format("parquet").mode("overwrite").save(output_path)
