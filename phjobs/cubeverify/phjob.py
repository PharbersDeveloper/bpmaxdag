...
def execute(a, b):
	...
	df = spark.read.parquet("s3a://ph-max-auto/2020-08-11/cube/dest/8cd67399-3eeb-4f47-aaf9-9d2cc4258d90/lattices/content").select("PRODUCT_NAME", "CITY_NAME", "CUBOIDS_ID", "CUBOIDS_NAME", "LATTLES")
