...
def execute(a, b):
	...
	df = spark.read.parquet("s3a://ph-max-auto/2020-08-11/cube/dest/8cd67399-3eeb-4f47-aaf9-9d2cc4258d90/result2/final-result/part-00000-f1c1eaed-f288-4bbd-847b-8b4044713f01-c000.snappy.parquet")
