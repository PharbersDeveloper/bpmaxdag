...
def execute(**kwargs):
    ...
    spark = SparkSession.builder \
        .master("yarn") \
        .appName("datamart original dim max_result_hosp job") \
    ...
    max_result_hosp_data_df = reading.select(
            "PHA",
			"Province",
			"City",
			"BEDSIZE",
    ...
    max_result_hosp_data_df.write.format("parquet").mode("overwrite").save(output_path)
