...
##################-----------------output------------------------###################
    ...
    result_path = result_path_prefix + kwargs["dosage_adjust_result"]
##################-----------------output------------------------###################
...
def load_effective_result(spark, path_effective_result):
    ...
    df_second_round = df_second_round.select("ID","DOSAGE","DOSAGE_STANDARD","PACK_ID_CHECK","JACCARD_DISTANCE")
