...
############## == atc_code_match == ###################
def atc_code_match_cmd(**context):
    ...
    params.update(var_key_lst.get("atc_code_match", {}))
    ...
    exec_phcli_submit = 'LANG=C.UTF-8 phcli maxauto --runtime python3 --group atc_code_match --path atc_code_match --cmd submit ' \
...
atc_code_match = PythonOperator(
    task_id='atc_code_match',
    provide_context=True,
    python_callable=atc_code_match_cmd,
    dag=dag
)
############## == atc_code_match == ###################
