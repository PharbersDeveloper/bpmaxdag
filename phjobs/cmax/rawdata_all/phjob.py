...
def execute(**kwargs):
    ...
    df_raw_data = readInFile(kwargs["df_raw_data"])
    df_rawdata_tianjin = readInFile(kwargs["df_rawdata_tianjin"])
    df_rawdata_shanghai = readInFile(kwargs["df_rawdata_shanghai"])
