...
@click.option('--g_if_others')
@click.option('--g_current_year')
@click.option('--g_current_month')
@click.option('--g_p_not_arrived')
@click.option('--g_p_published')
@click.option('--g_path_out')
