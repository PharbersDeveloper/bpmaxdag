...
def execute(**kwargs):
    ...
    path_original_mnf_mapping_table = depends["input_original_mnf_table"]
    ...
    output_mnf_mapping_table = result_path_prefix + kwargs["output_mnf_mapping_table"]
    ########### == output == ###########
    ...
    df_negative =  get_negative_mnf_mapping_elements(input_dataframe=df_negative\
    ...
    wirte_files(df,output_mnf_mapping_table)
...
def get_negative_mnf_mapping_elements(input_dataframe,input_mnf,input_standard_mnf,input_master,similarity):
...
def get_available_mnf_mapping_elements(input_dataframe_oringal, input_dataframe_negative):
