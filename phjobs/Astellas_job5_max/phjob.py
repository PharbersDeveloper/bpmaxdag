...
all_models, other_models, out_path, need_test):
    ...
    if int(need_test) > 0:
        ...
        my_out_path = u"s3a://ph-max-auto/v0.0.1-2020-06-08/Astellas/MAX_result/MAX_result_201401-202003痛风市场_hosp_level"
        R_out_path = u"/common/projects/max/Astellas/MAX_result/MAX_result_201401-202003痛风市场_hosp_level"
        phlogger.info(u"痛风市场")
        check_out(my_out_path, R_out_path)
        my_out_path = u"s3a://ph-max-auto/v0.0.1-2020-06-08/Astellas/MAX_result/MAX_result_201401-202003普乐可复市场_hosp_level"
        R_out_path = u"/common/projects/max/Astellas/MAX_result/MAX_result_201401-202003普乐可复市场_hosp_level"
        phlogger.info(u"普乐可复市场")
        check_out(my_out_path, R_out_path)
