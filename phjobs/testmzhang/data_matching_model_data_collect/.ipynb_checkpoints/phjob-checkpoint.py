...
def execute(**kwargs):
    ...
    print(depends["origin"])
    print(depends["prediction"])
    print('*******************')
#     origin_path = depends["origin"]
#     prediction_result_path = depends["prediction"]
    
    origin_path = kwargs["cleaning_origin"]
    prediction_result_path = kwargs["prediction_result"]
    ...
    print(path_prediction_origin_result)
    print(path_lost_data)
