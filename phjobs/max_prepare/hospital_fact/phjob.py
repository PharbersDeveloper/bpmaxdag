...
def execute(**kwargs):
    ...
    _base_path = str(kwargs["base_path"]).replace("${company}", _company)
    ...
    hosp_mapping = spark.read.parquet(_base_path).selectExpr("Panel_ID AS PHA_ID", "BEDSIZE", "Est_DrugIncome_RMB AS EST_DRUGINCOME_RMB")
    # fact_mapping = [
    #     {
    #         "CATEGORY": "EMPLOYEES",
    #         "TAG": "TOTAL",
