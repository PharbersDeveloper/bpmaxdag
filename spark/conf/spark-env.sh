...
export STANDALONE_SPARK_MASTER_HOST=ip-192-168-21-173.cn-northwest-1.compute.internal
...
export SPARK_PUBLIC_DNS=ip-192-168-21-173.cn-northwest-1.compute.internal
