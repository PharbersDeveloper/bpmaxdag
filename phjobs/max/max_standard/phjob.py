...
def execute(**kwargs):
    ...
    ### output args ###
    g_max_standard = kwargs['g_max_standard']
    g_max_standard_brief = kwargs['g_max_standard_brief']
    ### output args ###
    ...
    result_path_prefix = get_result_path({"name":job_name, "dag_name":g_dag_name, "run_id":g_run_id})
    depends_path = get_depends_path({"name":job_name, "dag_name":g_dag_name, 
                                     "run_id":g_run_id, 
                                     "depend_job_names_keys":g_depend_job_names_keys})
    # 没有更新过的job6结果
    ...
    # 输出
    p_max_standard =  result_path_prefix + g_max_standard
    p_max_standard_brief = result_path_prefix  + g_max_standard_brief
    
    # print(p_max_standard)
    # print(p_max_standard_brief)
    # print(p_max_result)
    # %%
    # ========== 数据 mapping =========
