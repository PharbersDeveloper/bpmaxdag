...
dag = DAG(
    dag_id="province_level",
    default_args=default_args,
    schedule_interval=None,
    description="province_level",
...
############## == province_level == ###################
def province_level_cmd(**context):
    ...
    params.update(var_key_lst.get("province_level", {}))
    ...
    exec_phcli_submit = 'LANG=C.UTF-8 phcli maxauto --runtime python3 --group province_level --path province_level --cmd submit ' \
...
province_level = PythonOperator(
    task_id='province_level',
    provide_context=True,
    python_callable=province_level_cmd,
    dag=dag
)
############## == province_level == ###################
