...
def job1_hospital_mapping_cmd(**context):
    ...
    exec_phcli_submit = 'phcli maxauto online_run --group Auto_Max_liyx --name job1_hospital_mapping ' \
...
def job2_product_mapping_cmd(**context):
    ...
    exec_phcli_submit = 'phcli maxauto online_run --group Auto_Max_liyx --name job2_product_mapping ' \
                        '--owner "{}" --run_id "{}" --job_id "{}" --context "{}" "{}"'.format(str(owner), str(run_id), str(job_id), str(params), str(args))
    process_cmd(exec_phcli_submit)
...
def job3_1_data_adding_cmd(**context):
    ...
    exec_phcli_submit = 'phcli maxauto online_run --group Auto_Max_liyx --name job3_1_data_adding ' \
                        '--owner "{}" --run_id "{}" --job_id "{}" --context "{}" "{}"'.format(str(owner), str(run_id), str(job_id), str(params), str(args))
    process_cmd(exec_phcli_submit)
...
def job3_2_data_adding_cmd(**context):
    ...
    exec_phcli_submit = 'phcli maxauto online_run --group Auto_Max_liyx --name job3_2_data_adding ' \
                        '--owner "{}" --run_id "{}" --job_id "{}" --context "{}" "{}"'.format(str(owner), str(run_id), str(job_id), str(params), str(args))
    process_cmd(exec_phcli_submit)
...
def job4_panel_cmd(**context):
    ...
    exec_phcli_submit = 'phcli maxauto online_run --group Auto_Max_liyx --name job4_panel ' \
                        '--owner "{}" --run_id "{}" --job_id "{}" --context "{}" "{}"'.format(str(owner), str(run_id), str(job_id), str(params), str(args))
    process_cmd(exec_phcli_submit)
...
def job5_max_weight_cmd(**context):
    ...
    exec_phcli_submit = 'phcli maxauto online_run --group Auto_Max_liyx --name job5_max_weight ' \
                        '--owner "{}" --run_id "{}" --job_id "{}" --context "{}" "{}"'.format(str(owner), str(run_id), str(job_id), str(params), str(args))
    process_cmd(exec_phcli_submit)
...
def job6_max_city_cmd(**context):
    ...
    exec_phcli_submit = 'phcli maxauto online_run --group Auto_Max_liyx --name job6_max_city ' \
                        '--owner "{}" --run_id "{}" --job_id "{}" --context "{}" "{}"'.format(str(owner), str(run_id), str(job_id), str(params), str(args))
    process_cmd(exec_phcli_submit)
...
def job7_max_standard_cmd(**context):
    ...
    exec_phcli_submit = 'phcli maxauto online_run --group Auto_Max_liyx --name job7_max_standard ' \
                        '--owner "{}" --run_id "{}" --job_id "{}" --context "{}" "{}"'.format(str(owner), str(run_id), str(job_id), str(params), str(args))
    process_cmd(exec_phcli_submit)
...
def job7_raw_standard_cmd(**context):
    ...
    exec_phcli_submit = 'phcli maxauto online_run --group Auto_Max_liyx --name job7_raw_standard ' \
                        '--owner "{}" --run_id "{}" --job_id "{}" --context "{}" "{}"'.format(str(owner), str(run_id), str(job_id), str(params), str(args))
    process_cmd(exec_phcli_submit)
...
def Max_check_cmd(**context):
    ...
    exec_phcli_submit = 'phcli maxauto online_run --group Auto_Max_liyx --name Max_check ' \
                        '--owner "{}" --run_id "{}" --job_id "{}" --context "{}" "{}"'.format(str(owner), str(run_id), str(job_id), str(params), str(args))
    process_cmd(exec_phcli_submit)
