...
def execute(**kwargs):
    ...
    if if_union == 'True':
        ...
        raw_data_dedup_delivery_all = union_raw_data(raw_data_dedup_delivery, history_raw_data_delivery, cpa_pha_map)     
    else:
        raw_data_dedup_delivery_all = dealIDLength(raw_data_dedup_delivery)
