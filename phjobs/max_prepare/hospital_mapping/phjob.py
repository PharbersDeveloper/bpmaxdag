...
def execute(**kwargs):
    ...
    df = reading \
        ...
        .agg(
                ...
                reverse(array_distinct(collect_list("Est_DrugIncome_RMB"))).alias("DRUGINCOME_RMBS"),
                ...
                reverse(array_distinct(collect_list("INTERNAL_DIAG_TIME"))).alias("INTERNAL_DIAG_TIMES"),
