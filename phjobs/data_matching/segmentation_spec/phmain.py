...
@click.option('--spec_lexicon_path')
@click.option('--spec_stopwords_path')
@click.option('--depend_job_names_keys')
@click.option('--g_repartition_shared')
@click.option('--segmentation_spec_result')
def debug_execute(**kwargs):
    try:
        args = {"name": "segmentation_spec"}
        outputs = ["segmentation_spec_result"]
