...
def execute(**kwargs):
    ...
    spark = SparkSession.builder \
        .master("yarn") \
        .appName("datamart original dim chc_prods job") \
...
#  |-- version: string (nullable = true)
    ...
    dest = reading.select(chc_prod_keys_lst).distinct().withColumn("_ID", monotonically_increasing_id())
    # dest.show(100)
    # logger.info(dest.count()) # 43645
