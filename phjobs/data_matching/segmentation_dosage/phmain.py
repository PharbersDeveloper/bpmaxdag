...
@click.option('--dosage_lexicon_path')
@click.option('--dosage_stopwords_path')
@click.option('--depend_job_names_keys')
@click.option('--g_repartition_shared')
@click.option('--segmentation_dosage_result')
def debug_execute(**kwargs):
    try:
        args = {"name": "segmentation_dosage"}
        outputs = ["segmentation_dosage_result"]
