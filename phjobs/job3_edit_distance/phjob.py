...
def execute():
	...
	def edit_distance_total(ed_DOSAGE, ed_SPEC, ed_PACK, ed_MNF_NAME_CH, ed_MNF_NAME_EN, ed_PROD_NAME_CH):
		# 计算总编辑距离
		ed = ed_DOSAGE + 10*ed_SPEC + 100*ed_PACK + min(ed_MNF_NAME_CH, ed_MNF_NAME_EN) + ed_PROD_NAME_CH
		return ed
	...
	# cpa_ed = cpa_ed.withColumn("ed_total", edit_distance_total(ed_DOSAGE="ed_DOSAGE", ed_SPEC="ed_SPEC", ed_PACK="ed_PACK", ed_MNF_NAME_CH="ed_MNF_NAME_CH", ed_MNF_NAME_EN="ed_MNF_NAME_EN", ed_PROD_NAME_CH="ed_PROD_NAME_CH"))
