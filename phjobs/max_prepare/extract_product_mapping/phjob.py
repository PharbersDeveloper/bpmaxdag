...
def execute(**kwargs):
    ...
    _inputs = str(kwargs["product_mapping_inputs"]).replace(" ", "").split(",")
    _time = str(kwargs["time"])
    _output = str(kwargs["output_prod_mapping_path"])
    ...
    def get_df(path):
        ...
        return original_product_df.selectExpr("ORIGINAL_MIN AS MIN", "PACK_ID", "COMMON_NAME AS MOLE_NAME", "PRODUCT_NAME", "SPECIFICATIONS AS SPEC", "DOSAGE", "PACK_NUMBER", "MANUFACTURER AS MNF_NAME", "TIME", "COMPANY")
